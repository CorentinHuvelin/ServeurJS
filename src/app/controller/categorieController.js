...
class CategorieController {
  ...
  //recupère le numéro entré dans la route et le met en argument de findNameById du DAO
  findNameById(req, res) {
    let id = req.params.id;
    this.categorieDAO
      .findNameById(id)
      .then(this.common.findSuccess(res))
  ...
  //recupère le numéro entré dans la route et le met en argument de findModById du DAO
  findModById(req, res) {
    let id = req.params.id;
    this.categorieDAO
      .findModById(id)
